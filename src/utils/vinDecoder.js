...
export async function decodeVIN(vin) {
  ...
  try {
    if (__DEV__) console.log('Decoding VIN:', vin);
    ...
    if (!data.Make || !data.Model) {
      if (__DEV__) console.warn('Incomplete VIN data:', { Make: data.Make || 'MISSING', Model: data.Model || 'MISSING' });
    ...
    if (__DEV__) console.log('VIN decoded successfully:', decodedData);
